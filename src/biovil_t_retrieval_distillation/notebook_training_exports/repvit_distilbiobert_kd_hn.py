...
# Source notebook: project training notebooks/repvit-distilbiobert-kd-hn-updated.ipynb
...
# %% [markdown] cell 49
# ## Thoughts
# The RepViT-M1.1 + DistilBioBERT distillation experiment can support decoder-based report generation extensions.
